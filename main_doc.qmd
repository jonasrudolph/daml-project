...
# Zu einem Data Frame konvertieren
cor_df <- as.data.frame(cor_matrix)
cor_df$row <- rownames(cor_matrix)

# Melt der Daten für die Verwendung in ggplot
cor_melted <- reshape2::melt(cor_df, id.vars = "row")

# Plot erstellen
ggplot(cor_melted, aes(x = row, y = variable, fill = value)) +
  geom_tile() +
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "Korrelationsmatrix der Daten")
