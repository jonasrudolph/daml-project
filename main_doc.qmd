...
Aufgrund dieser Kurve haben wir uns dzu entschieden eine weitere Variable hinzuzufügen so wie die Quadrierte Zahl von Years.Of.Experience. Da Age zwar einen hohen Korrelationswert hat aber auch mit den Years.Of.Experience einhergeht nehmen wir diesen wert nicht sondern stattdessen das Education.Level.
...
Hinzufügen von Years.Of.Experience\^2
...
Die Z-Skalierung ist eine Methode zur Standardisierung von numerischen Variablen. Bei der Z-Skalierung werden alle numerischen Werte mit Ausnahme des Vorhersagewerts (Salary) skaliert, um die Auswirkungen von Ausreißern zu minimieren. (Salary und Years.Of.Experience\^2 ausgenommen):
